...
import { Search } from '4-features/Search/ui/Search';
...
import { useLogoutDialog } from '6-shared/ui/LogoutDialog';
import { userActions } from '../../../../../TEST/final_project/src/5-entities/user/model/user';
...
export const Header = memo(() => {
	...
	const { confirm, element } = useLogoutDialog();
